...
<div class="container mt-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <a href="{{ route('back.articles.create') }}"
            class="btn btn-success btn-lg fw-bold shadow-sm d-flex align-items-center gap-2"
            style="border-radius: 50px; transition: background-color 0.3s, transform 0.2s;">
            <span style="font-size: 1.4rem;">➕</span> Ajouter un article
        </a>
        ...
        <table class="table table-hover align-middle mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center text-capitalize">{{ $article->genre ?? 'N/A' }}</td>
